...
SECTION_PROMPTS = {
    ...
    "financial_analysis": {
        ...
        "prompt": (
            ...
            "REGULI STRICTE ANTI-HALUCINARE:\n"
            "- NU CALCULA ROE daca nu ai capitaluri proprii in date.\n"
            "- NU CALCULA ROA daca nu ai total active in date.\n"
            "- NU CALCULA marja profit daca nu ai profit net in date.\n"
            "- PENTRU FIECARE RATIO: scrie EXPLICIT daca datele sunt incomplete.\n"
            "- Daca o valoare lipseste, scrie '[INDISPONIBIL — date insuficiente]' in loc de estimare.\n"
            "- NU INVENTA procente, ratii sau comparatii sectoriale fara date concrete.\n\n"
            "EXEMPLU FRAGMENT:\n"
    ...
    "opportunities": {
        ...
        "prompt": (
            ...
            "Foloseste licitatiile deschise, programele de finantare si contractele SEAP "
            "listate in sectiunea CONTEXT STRUCTURAT (si in JSON) — sunt DATE REALE deja "
            "colectate din surse.\n"
            ...
            "Daca datele CHIAR NU contin nicio licitatie, finantare sau contract, scrie: "
            "'Nu au fost identificate oportunitati concrete in sursele consultate.' "
            "DACA datele contin astfel de oportunitati (chiar daca relevanta lor directa "
            "pentru profilul firmei e limitata), prezinta-le si evalueaza EXPLICIT gradul "
            "de potrivire — NU scrie ca nu s-a gasit nimic si NU marca '[INDISPONIBIL]'. "
            "NU INVENTA licitatii, fonduri sau proiecte.\n\n"
            "EXEMPLU FRAGMENT (adapteaza la datele reale):\n"
