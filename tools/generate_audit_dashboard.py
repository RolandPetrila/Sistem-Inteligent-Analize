...
EXTERNAL_SOURCES = [
    ...
    ("AEGRM (garantii mobiliare)", "aegrm_client.py", "Gratuit, fara cheie", "TESTABIL live (detecteaza explicit auto-fetch indisponibil + indica calea manuala). Verificat 2026-07-12: auto-fetch DNS-dead ([Errno 11001] getaddrinfo failed).", "CONFIRMAT: auto-fetch AEGRM (aegrm.justportal.ro) tot DNS-dead, nereparabil din cod. DAR capacitatea 'garantii reale mobiliare' NU e pierduta — verificare manuala la co.rnpm.ro (portalul RNPM oficial, viu; verificat 2026-07-26). Linia e deja in raport (CERINTA #4).", "aegrm"),
